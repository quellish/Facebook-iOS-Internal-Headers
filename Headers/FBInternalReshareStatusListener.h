...
@interface FBInternalReshareStatusListener : NSObject <FBComposerPublisherStatusListener>
{
    FBComposerPublisherData *_publisherData;
    CDUnknownBlockType _successfullyPublishedBlock;
}
...
- (id)initWithPublisherData:(id)arg1 successfullyPublishedBlock:(CDUnknownBlockType)arg2;
