...
@protocol FBMessengerInboxCountsFetcherDelegate, FBServiceTransactionMutating;
...
@property(nonatomic) __weak id <FBMessengerInboxCountsFetcherDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
