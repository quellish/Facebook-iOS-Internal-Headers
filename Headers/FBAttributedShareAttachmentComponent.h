...
@class FBFeedComponentToolbox, FBIntentTarget, FBMemFeedStory, FBMemStoryAttachment, NSString;

@interface FBAttributedShareAttachmentComponent : CKCompositeComponent <FBStoryAttachmentRenderingComponent>
{
