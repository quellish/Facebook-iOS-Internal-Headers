...
#import "FBReactionPlaceQuestionCardViewDelegate-Protocol.h"
...
@interface FBReactionPlaceQuestionAttachmentsAdapter : NSObject <FBReactionPlaceQuestionCardViewDelegate, FBReactionAttachmentsAdapter>
{
