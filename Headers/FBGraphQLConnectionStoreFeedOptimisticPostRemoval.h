...
@interface FBGraphQLConnectionStoreFeedOptimisticPostRemoval : NSObject <FBGraphQLConnectionStoreListener, FBGraphQLConnectionControllerListener>
{
}

- (void)_removeOptimisticPostsFromConnection:(id)arg1 previousState:(id)arg2 insertedEdgesIndexPaths:(id)arg3;
- (void)_removeOptimisticPostsFromConnection:(id)arg1 previousState:(id)arg2 insertedChunkIndex:(unsigned int)arg3;
