...
#import "FBPermalinkStatePersister-Protocol.h"

@class FBSessionScopedFileCache, NSString;
@protocol FBPermalinkStateCachingListener;

@interface FBPermalinkStateCache : NSObject <FBObjectCachingListener, FBPermalinkStatePersister>
{
    id <FBPermalinkStateCachingListener> _listener;
...
- (void)writePermalinkState:(id)arg1;
- (void)readPermalinkState;
- (id)init;
