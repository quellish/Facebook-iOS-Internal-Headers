...
@protocol FBMusicPlayerListener;

@interface FBMusicPlayerEventsMatchingURLFilter : NSObject <FBMusicPlayerListener>
{
    id <FBMusicPlayerListener> _listener;
    NSArray *_urls;
    NSDictionary *_respondsToSelectorCache;
}

- (void).cxx_destruct;
- (void)assertURL;
- (BOOL)urlMatches:(id)arg1;
...
- (void)filterEventsMatchingURLs:(id)arg1;
- (void)filterEventsMatchingURL:(id)arg1;
