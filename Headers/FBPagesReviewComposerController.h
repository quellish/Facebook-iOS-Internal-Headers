...
@class FBComposerPublisherStatusEventFilter, FBPublisherManager, FBUserSession, NSString;
@protocol FBPagesReviewComposerControllerDelegate;

@interface FBPagesReviewComposerController : NSObject <FBComposerPublisherStatusListener, FBComposerFlowDelegate>
{
...
- (void)dealloc;
- (id)initWithSession:(id)arg1 pageFBID:(id)arg2 analyticsUUID:(id)arg3;
