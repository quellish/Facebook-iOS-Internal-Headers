...
@interface FBSearchResultsEntityUserAccessoryComponent : CKCompositeComponent
{
...
- (void).cxx_destruct;
- (void)didTapMessagingActionButton:(id)arg1;
- (void)didTapFriendingActionButton:(id)arg1;
