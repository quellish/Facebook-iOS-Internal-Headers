...
@interface FBFriendsNearbyEntityCardDataSourceAdapter : NSObject <FBEntityCardsPageDownloadRequestProvider>
{
    FBUserSession *_session;
}

+ (id)entityCardDataSourceWithEntities:(id)arg1 initialSelectedIndex:(unsigned int)arg2 session:(id)arg3;
- (void).cxx_destruct;
