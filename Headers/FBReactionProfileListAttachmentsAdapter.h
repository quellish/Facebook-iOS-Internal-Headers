...
@interface FBReactionProfileListAttachmentsAdapter : NSObject <_FBReactionAdapterProfileHelperDelegate, _FBReactionAdapterHelperDelegate, FBReactionAttachmentActionAdapterDelegate, FBReactionAttachmentsAdapter>
{
...
+ (id)_itemViewForAttachment:(id)arg1 attachmentAction:(id)arg2 atIndex:(int)arg3 renderIdiom:(int)arg4 session:(id)arg5 attachmentStyle:(id)arg6;
