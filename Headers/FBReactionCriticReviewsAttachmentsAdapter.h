...
@class FBReactionAdapterContext, NSArray, NSMutableArray, NSString, UIView;
@protocol FBQueriedReactionUnitFieldsProtocol, FBReactionActionAdapter, FBReactionAttachmentsAdapterDelegate;

@interface FBReactionCriticReviewsAttachmentsAdapter : NSObject <_FBReactionAdapterProfileHelperDelegate, _FBReactionAdapterHelperDelegate, FBReactionAttachmentsAdapter>
{
...
- (void).cxx_destruct;
- (unsigned int)_indexOfTarget:(id)arg1 inProfiles:(id)arg2;
- (id)_allReviewerProfiles;
