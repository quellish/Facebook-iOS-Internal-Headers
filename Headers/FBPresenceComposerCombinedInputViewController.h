...
@class FBNetworkImageView, FBPresenceIconView, FBUserSession, NSString, UIButton, UITapGestureRecognizer, UIView;
@protocol FBPresenceComposerInputControl, FBPresenceComposerInputListener;

@interface FBPresenceComposerCombinedInputViewController : UIViewController <FBPresenceFeedDataSourceListener, FBPresenceComposerListener, FBPresenceComposerInputView>
{
    ...
    UIViewController<FBPresenceComposerInputControl> *_searchFieldViewController;
...
- (void)placeButtonTapped:(id)arg1;
- (void)iconViewTapped:(id)arg1;
- (void)viewWillLayoutSubviews;
- (void)dealloc;
- (void)viewDidLoad;
- (id)initWithSession:(id)arg1 searchFieldViewController:(id)arg2 inputListener:(id)arg3;
