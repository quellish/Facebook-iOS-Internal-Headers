...
@class FBComposerPublicationStatusEventTranslator, FBComposerPublisherStatusEventFilter, NSString;
@protocol FBCompositionModelBundleCache, FBCompositionOwnershipTracker;

@interface FBFeedOutboxPublicationHandler : NSObject <FBComposerPublisherStatusListener>
{
    ...
    BOOL _hasStartedTrackingUnpublishedOwnedPublications;
...
- (void)trackPublicationWithIdentifier:(id)arg1;
- (void)trackUnpublishedOwnedPublications;
- (id)initWithCompositionModelBundleCache:(id)arg1 compositionOwnershipTracker:(id)arg2 listener:(id)arg3;
