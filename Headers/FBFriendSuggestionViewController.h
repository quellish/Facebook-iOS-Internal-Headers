...
@class FBComponentTableViewDataSource, FBFriendingSimpleDataSourceHelper, FBFriendingToolbox, FBPullToRefreshView, FBScenePath, FBUserSession, NSObject, NSString;
@protocol FBFriendCenterScrollDelegate, FBPYMKStreamProtocol;

@interface FBFriendSuggestionViewController : FBTableViewController <FBFriendCenterItem, CKComponentProvider, FBComponentTableViewDataSourceSelectionEventListener, FBComponentScrollEventListener, FBComponentTableViewDataSourceSectionHeaderHandler, FBComponentTableViewDataSourceCellConfigProvider, FBPYMKStreamListener, FBPullToRefreshViewDelegate>
{
