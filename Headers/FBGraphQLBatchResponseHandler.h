...
@class FBGraphQLBatchResponsesBuffer, FBGraphQLResponse, FBReceivedChunkedDataMemoryBuffer, FBResponseProcessor, FBResponseProcessorConfiguration, NSHTTPURLResponse, NSString;
@protocol FBRequest, FBResponseHandlerDelegate, OS_dispatch_queue;
