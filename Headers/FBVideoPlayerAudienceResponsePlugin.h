...
@class FBUserSession, FBVideoAudienceResponseController, NSString;
@protocol FBVideoPlaybackController;

@interface FBVideoPlayerAudienceResponsePlugin : UIView <FBVideoPluginView>
{
    struct CGRect _videoFrame;
    id <FBVideoPlaybackController> _videoController;
    FBVideoAudienceResponseController *_videoGestureController;
