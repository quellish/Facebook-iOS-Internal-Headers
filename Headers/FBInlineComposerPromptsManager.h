...
#import "FBInlineComposerPromptsProviderListener-Protocol.h"

@class FBInlineComposerPrompt, FBInlineComposerPromptsProviderListenerAnnouncer, NSArray, NSString;
