...
@class FBMemInstantShoppingDocument, FBRichStoryPresentationState, FBRichStoryViewModel, FBViewModelAdapterRegistry, NSString;

@interface FBRichStoryInstantShoppingDocumentAdapter : NSObject <FBRichStoryAdapter>
{
...
- (id)initWithShoppingDocument:(id)arg1;
