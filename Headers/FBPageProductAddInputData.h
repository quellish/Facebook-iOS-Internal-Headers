...
@interface FBPageProductAddInputData : FBGraphQLInput
{
    NSString *_clientMutationId;
    NSString *_actorId;
    NSString *_menuCategory;
    NSString *_pageId;
...
@property(copy, nonatomic) NSString *menuCategory; // @synthesize menuCategory=_menuCategory;
