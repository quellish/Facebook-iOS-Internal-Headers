...
@class FBFeedComponentToolbox, FBIntentAnalyticsInfo, FBIntentTarget, NSString;

@interface FBImageShareAttachmentComponent : CKCompositeComponent <FBStoryAttachmentRenderingComponent>
{
    NSString *_storyID;
...
+ (BOOL)isVideoAutoplayAllowedForSession:(id)arg1;
...
+ (id)supportedStyles;
- (void).cxx_destruct;
- (void)didTapImageAttachmentCard:(id)arg1;
