...
@class FBFeedComponentToolbox, FBIntentAnalyticsInfo, FBIntentTarget, FBMemStoryAttachment, NSString;

@interface FBCommerceProductItemAttachmentComponent : CKCompositeComponent <FBStoryAttachmentRenderingComponent>
{
