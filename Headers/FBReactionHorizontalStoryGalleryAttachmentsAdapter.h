...
@interface FBReactionHorizontalStoryGalleryAttachmentsAdapter : NSObject <_FBReactionAdapterHelperDelegate, UIScrollViewDelegate, FBReactionAttachmentsAdapter>
{
...
- (id)horizontalGalleryForStoryAttachments:(id)arg1 session:(id)arg2;
