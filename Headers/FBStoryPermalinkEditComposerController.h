...
@class FBPublisherManager, FBUserSession, NSString;

@interface FBStoryPermalinkEditComposerController : NSObject <FBComposerPublisherStatusListener, FBComposerFlowDelegate>
{
...
- (void)dealloc;
- (id)initWithSession:(id)arg1 withLayoutIdiom:(unsigned int)arg2;
