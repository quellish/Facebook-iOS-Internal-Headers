...
@class FBAuthUsernamePasswordFlowController, FBDBLUserChooserFlowController, FBRequesterConfiguration, NSString;
@protocol FBAuthControllingDelegate, FBAuthUIPresenting, FBDeviceBasedLoginFlowUIProviding;
...
@property(readonly, nonatomic) id <FBDeviceBasedLoginFlowUIProviding> uiProvider; // @synthesize uiProvider=_uiProvider;
