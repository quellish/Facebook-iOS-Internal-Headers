...
@class FBComposerPublisherStatusEventReplayer, FBComposerPublisherStatusListenerAnnouncer, NSString;

@interface FBFeedPublicationTracker : NSObject <FBComposerPublisherStatusListener>
{
    FBComposerPublisherStatusListenerAnnouncer *_announcer;
    FBComposerPublisherStatusEventReplayer *_eventReplayer;
}
