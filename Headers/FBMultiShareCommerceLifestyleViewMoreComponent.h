...
@interface FBMultiShareCommerceLifestyleViewMoreComponent : CKCompositeComponent <FBHScrollImpressionLogging>
{
...
+ (id)newWithAttachment:(id)arg1 toolbox:(id)arg2 becameFullyVisibleAction:(SEL)arg3 tapAttachmentAction:(SEL)arg4;
- (void).cxx_destruct;
