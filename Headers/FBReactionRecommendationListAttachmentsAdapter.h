...
@class FBReactionAdapterContext, FBReactionTwoColumnSizedListView, FBUserSession, NSArray, NSMutableArray, NSString, UIView;
@protocol FBQueriedReactionUnitFieldsProtocol, FBReactionActionAdapter, FBReactionAttachmentsAdapterDelegate;

@interface FBReactionRecommendationListAttachmentsAdapter : NSObject <_FBReactionAdapterHelperDelegate, FBReactionAttachmentsAdapter>
{
...
+ (id)_itemViewForAttachment:(id)arg1 session:(id)arg2 itemViewSizeByLines:(unsigned int)arg3;
...
@property(retain, nonatomic) FBReactionTwoColumnSizedListView *actionView; // @synthesize actionView=_actionView;
@property(retain, nonatomic) UIView *attachmentsView; // @synthesize attachmentsView=_attachmentsView;
@property(copy, nonatomic) NSArray *actionAdapters; // @synthesize actionAdapters=_actionAdapters;
