...
@class FBReactionAdapterContext, FBReactionCenteredHeaderView, FBUserSession, NSString;
@protocol FBQueriedReactionUnitFieldsProtocol, FBReactionHeaderAdapterDelegate;

@interface FBReactionCenterAlignedHeaderAdapter : NSObject <FBReactionActionAdapterDelegate, FBReactionHeaderAdapter>
{
    FBUserSession *_session;
    id <FBQueriedReactionUnitFieldsProtocol> _unit;
    FBReactionCenteredHeaderView *_headerView;
