...
@protocol FBHasAttributedString, FBQueriedReactionUnitFieldsProtocol, FBReactionActionAdapter, FBReactionAttachmentsAdapterDelegate;

@interface FBReactionResidenceMigrationAttachmentsAdapter : NSObject <FBReactionAttachmentsAdapter>
{
