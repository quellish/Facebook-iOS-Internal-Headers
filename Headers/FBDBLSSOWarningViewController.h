...
@class FBAuthenticationRoundedImageView, FBDBLSSOWarningView, FBDBLStoredUser, FBGatekeeper, FBImageDownloader, NSString;
...
@property(readonly, nonatomic) FBDBLSSOWarningView *ssoWarningView; // @synthesize ssoWarningView=_ssoWarningView;
