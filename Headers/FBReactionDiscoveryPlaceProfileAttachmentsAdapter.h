...
@interface FBReactionDiscoveryPlaceProfileAttachmentsAdapter : NSObject <_FBReactionAdapterProfileHelperDelegate, FBReactionAttachmentsAdapter>
{
...
+ (id)_itemViewForAttachment:(id)arg1 withRenderIdiom:(int)arg2 session:(id)arg3 atIndex:(unsigned int)arg4;
