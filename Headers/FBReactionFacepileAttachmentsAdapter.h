...
@interface FBReactionFacepileAttachmentsAdapter : NSObject <_FBReactionAdapterProfileHelperDelegate, FBReactionAttachmentsAdapter>
{
...
- (BOOL)shouldDisplayEllipsisViewForConnection:(id)arg1 withCurrentCount:(int)arg2;
