...
@class FBDelayServicesOnColdStartExperimentContext, FBUserSession, NSSet, NSString;

@interface FBGuideNullStateService : NSObject <FBAppService>
{
...
- (void).cxx_destruct;
- (void)_applicationForegroundedAndIdling:(id)arg1;
