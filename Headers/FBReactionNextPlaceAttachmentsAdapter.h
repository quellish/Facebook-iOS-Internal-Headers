...
@class FBUserSession, NSArray, NSMutableArray, NSString, UIView;
@protocol FBQueriedReactionUnitFieldsProtocol, FBReactionActionAdapter, FBReactionAttachmentsAdapterDelegate;

@interface FBReactionNextPlaceAttachmentsAdapter : NSObject <_FBReactionAdapterProfileHelperDelegate, FBReactionAttachmentsAdapter>
{
...
- (void).cxx_destruct;
- (id)_pullProfiles;
- (id)_profileImageViewForPage:(id)arg1;
- (id)_reviewFooterForContactRecommendationFields:(id)arg1;
