...
+ (id)experimentName;
@property(nonatomic) int minBandwithState; // @synthesize minBandwithState=_minBandwithState;
@property(nonatomic) BOOL checkCache; // @synthesize checkCache=_checkCache;
