...
@class FBReactionAdapterContext, FBReactionWeatherConditionUnitComponentView, NSString;
@protocol FBQueriedReactionUnitComponentFieldsProtocol;

@interface FBReactionWeatherConditionUnitComponentAdapter : FBReactionBaseUnitComponentAdapter
{
    FBReactionWeatherConditionUnitComponentView *_componentView;
