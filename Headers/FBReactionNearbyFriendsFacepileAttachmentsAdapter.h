...
@class FBReactionNearbyFriendsFacepileView, FBUserSession, NSString;
@protocol FBQueriedReactionUnitFieldsProtocol, FBReactionActionAdapter, FBReactionAttachmentsAdapterDelegate;

@interface FBReactionNearbyFriendsFacepileAttachmentsAdapter : NSObject <FBReactionAttachmentsAdapter>
{
    id <FBQueriedReactionUnitFieldsProtocol> _unit;
    FBUserSession *_session;
    FBReactionNearbyFriendsFacepileView *_attachmentsView;
