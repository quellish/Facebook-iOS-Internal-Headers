...
@interface FBApplicationMobileTraceService : NSObject <FBAppService>
{
    FBUserSession *_session;
    BOOL _localTraceEnabled;
    BOOL _runLoopTraceEnabled;
}

- (void).cxx_destruct;
- (void)_setVerbosePerformanceTracingEnabled:(BOOL)arg1;
- (void)_configureLocalTracing;
- (void)_configureVerbosePerformanceTracing:(id)arg1;
