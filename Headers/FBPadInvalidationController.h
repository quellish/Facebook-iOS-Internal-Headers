...
@interface FBPadInvalidationController : NSObject <FBGraphQLConnectionStoreEdgeFiltering, FBFeedGraphQLConnectionManagerListener>
{
    BOOL _deviceIsPad;
}
...
- (id)initWithDeviceIsPad:(BOOL)arg1;
