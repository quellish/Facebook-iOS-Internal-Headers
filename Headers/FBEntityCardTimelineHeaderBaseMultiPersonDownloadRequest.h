...
@interface FBEntityCardTimelineHeaderBaseMultiPersonDownloadRequest : FBGraphQLDownloadRequest
{
...
- (void).cxx_destruct;
- (id)initWithTargetIDs:(id)arg1 coverWidth:(id)arg2 coverHeight:(id)arg3 contextItemImageSize:(float)arg4 callbackPerformer:(id)arg5 session:(id)arg6 displaySurface:(id)arg7;
- (id)newQuery;
