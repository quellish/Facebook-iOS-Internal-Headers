...
@interface FBReactionPhotoGridComponentController : CKComponentController <FBPhotoComponentPhotoViewProviderDelegate>
{
}

- (id)_photoComponentForPhoto:(id)arg1;
- (unsigned int)_indexOfPhoto:(id)arg1;
