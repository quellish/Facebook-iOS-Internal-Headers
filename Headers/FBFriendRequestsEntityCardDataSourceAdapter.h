...
@interface FBFriendRequestsEntityCardDataSourceAdapter : NSObject <FBEntityCardsPageDownloadRequestProvider>
{
    FBUserSession *_session;
    NSArray *_requestIDsArray;
}

+ (id)entityCardDataSourceForPendingRequestsArray:(id)arg1 initialSelectedIndex:(unsigned int)arg2 session:(id)arg3;
- (void).cxx_destruct;
