...
- (id)init;
- (id)initWithUserID:(id)arg1 firstPageSize:(unsigned int)arg2 shouldLoadStreamingImage:(id)arg3 accessTokenOverride:(id)arg4;
- (id)initWithUserID:(id)arg1 shouldLoadStreamingImage:(id)arg2;
