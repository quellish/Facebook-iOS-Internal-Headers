...
@interface FBNotificationsDuplicatesInvalidationController : NSObject <FBGraphQLConnectionStoreEdgeFiltering>
{
    id <FBGraphQLConnectionInterface> _connection;
}

@property(readonly, nonatomic) __weak id <FBGraphQLConnectionInterface> connection; // @synthesize connection=_connection;
- (void).cxx_destruct;
