...
@interface FBGroupsAdminsDataSource : NSObject <FBGroupsDataSourceProtocol, UITableViewDataSource, UITableViewDelegate>
{
    NSString *_groupID;
...
- (void)removeAdminID:(id)arg1;
- (id)adminForIndexPath:(id)arg1;
- (void)dealloc;
