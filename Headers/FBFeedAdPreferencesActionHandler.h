...
@interface FBFeedAdPreferencesActionHandler : NSObject <FBFeedSecondaryActionHandler>
{
}

- (id)_actionsForFeedUnit:(id)arg1 feedback:(id)arg2 trackingCodes:(id)arg3 context:(id)arg4;
