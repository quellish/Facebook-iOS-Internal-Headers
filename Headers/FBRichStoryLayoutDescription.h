...
@property(retain, nonatomic) NSMutableDictionary *elementsByID; // @synthesize elementsByID=_elementsByID;
- (void).cxx_destruct;
- (id)unionWithLayoutDescription:(id)arg1;
- (void)addElementDescriptor:(id)arg1;
- (id)elementForID:(id)arg1;
- (void)_enumerateElementsWithBlock:(CDUnknownBlockType)arg1;
