...
@interface FBAvatarSequenceCollectionRequestProvider : NSObject <FBEntityCardsPageDownloadRequestProvider>
{
    FBUserSession *_session;
    unsigned int _avatarRelation;
    NSString *_targetFBID;
    NSString *_source;
}

- (void).cxx_destruct;
- (void)setAvatarSequenceRelation:(unsigned int)arg1 targetFBID:(id)arg2 source:(id)arg3;
